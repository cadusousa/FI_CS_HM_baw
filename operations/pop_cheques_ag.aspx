<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pop_cheques_ag.aspx.cs" Inherits="operations_pop_cheques"  Title="AIMAR - BAW"%>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" />
        ...
        <tr>
            <td>
                ...
                <br />
                Cuenta:
                <asp:TextBox ID="tb_cuenta_contable" runat="server" Height="16px" Width="118px"></asp:TextBox>
