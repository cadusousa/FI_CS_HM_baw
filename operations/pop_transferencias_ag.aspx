<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pop_transferencias_ag.aspx.cs" Inherits="operations_pop_cheques"  Title="AIMAR - BAW"%>
...
<body>
    <div id="content">
    <div id="box">
    <h3 id="adduser">TRANSFERENCIA BANCARIA</h3>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" />
        ...
        <tr>
            <td>
                ...
                Número de referencia:                 <asp:TextBox ID="tb_chequeNo" 
