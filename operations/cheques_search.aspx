<%@ Page Language="C#" MasterPageFile="~/operations/manager.master" AutoEventWireup="true" CodeFile="cheques_search.aspx.cs" Inherits="operations_cheques_search" Title="AIMAR - BAW" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" Runat="Server">
<div id="box">
<h3 id="adduser">BUSCAR CHEQUE</h3>
...
<table width="650">
    <tr><td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>                    
                    <asp:DropDownList ID="lb_ted_id" runat="server">
                        ...
                        <asp:ListItem Value="14">Anticipado</asp:ListItem>
                    </asp:DropDownList>                    
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Fecha Inicio: </td>
                <td><asp:TextBox ID="tb_fechainicial" runat="server" Height="16px" Width="100px"></asp:TextBox>
                    ...
                    <cc1:CalendarExtender ID="tb_fechainicial_CalendarExtender" runat="server" 
                        TargetControlID="tb_fechainicial" Format="MM/dd/yyyy">
                    </cc1:CalendarExtender>
                </td>
            </tr>
            <tr>
                <td>Fecha Final: </td>
                <td> <asp:TextBox ID="tb_fechafinal" runat="server" Height="16px" Width="100px"></asp:TextBox>
                    ...
                    <cc1:CalendarExtender ID="tb_fechafinal_CalendarExtender" runat="server" 
                        TargetControlID="tb_fechafinal" Format="MM/dd/yyyy">
                    </cc1:CalendarExtender>
                </td>
            </tr>
            <tr>
