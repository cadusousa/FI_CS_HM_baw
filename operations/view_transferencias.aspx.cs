...
public partial class operations_pop_cheques : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack) {
            ...
            if (Request.QueryString["chequeNo"] == null || Request.QueryString["chequeNo"].ToString().Trim().Equals("")) {
                WebMsgBox.Show("Debe indicar el número de Transferencia de que desea visualizar");
                return;
            }
            ...
            tb_chequeNo.Text = rgb_cheque.strC9;
            ...
            //obtengo el listado de cortes Pagados
            ...
            gv_detalle_partida.DataSource = DB.getPolizaDiario(user, double.Parse(rgb_cheque.intC1.ToString()), 19, 0);
    ...
    protected void btn_imprimir_Click(object sender, EventArgs e)
    {
        ...
        //string script = "window.open('../invoice/re_print.aspx?fac_id=" + Request.QueryString["chequeNo"].ToString() + "&tipo=6&ctaID=" + lb_cuentas_bancarias.SelectedValue + "&correlativo=" + tb_chequeNo.Text + "','Imprimir','menubar=1,resizable=1,scrollbars=1,toolbar=1,width=750');";
    ...
    protected void btn_printret_Click(object sender, EventArgs e)
    {
        ...
        // Get a ClientScriptManager reference from the Page class.
        ClientScriptManager cs2 = Page.ClientScript;
        string script = "window.open('pop_retenciontoreprintlist.aspx?chequetransID=" + lb_correlativo.Text + "','Imprimir','menubar=1,resizable=1,scrollbars=1,toolbar=1,width=750');";
