<%@ Page Language="C#" MasterPageFile="~/operations/manager.master" AutoEventWireup="true" CodeFile="cheques.aspx.cs" Inherits="operations_pop_cheques" Title="AIMAR - BAW" %>
    ...
    <table align="center" cellpadding="0" cellspacing="0" style="width: 93%">
        <tr>
            ...
            <td>
                ...
                <asp:Label ID="lbl_tcg_id" runat="server" Text="0" Visible="False"></asp:Label>
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                Width="550px" ReadOnly="True"></asp:TextBox>
                    </td>
        </tr>
        <tr>
            <td>
                Direccion</td>
            <td>
                <asp:TextBox ID="tb_direccion" runat="server" Height="16px" Width="300px" 
                    ReadOnly="True"></asp:TextBox>
                    </td>
            <td>
                Teléfono</td>
            <td>
                    <asp:TextBox ID="tb_telefono" runat="server" Height="16px" Width="125px" 
                        ReadOnly="True"></asp:TextBox>
                    </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td bgcolor="#99FFCC">
                <asp:TextBox ID="tb_chequeNo" 
                    runat="server" Height="16px" Width="150px" Enabled="False"></asp:TextBox>
                </td>
            <td bgcolor="#99FFCC">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="tb_acreditado" runat="server" 
                    Height="16px" Width="550px"></asp:TextBox>
                </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                Referencia</td>
            <td colspan="3">
                <asp:TextBox ID="tb_referencia" runat="server" Height="16px" Width="550px"></asp:TextBox>
                </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <table width="650">
                <thead>
                <tr>
                    <th>Documentos para pagar con este Cheque</th>
                </tr>
                </thead>
        ...
        <tr>
            <td align="center" colspan="4">
                ...
                <cc1:FilteredTextBoxExtender ID="tb_cargoadicional_FilteredTextBoxExtender" 
                    runat="server" Enabled="True" TargetControlID="tb_cargoadicional"
                    FilterType="Numbers,Custom" ValidChars="." > 
                </cc1:FilteredTextBoxExtender>
                        </td>
                        <td>
                <asp:Button ID="btn_calcular" runat="server" onclick="btn_calcular_Click" 
                    Text="Agregar" ValidationGroup="b" />
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table align="center" cellpadding="0" cellspacing="0" style="width: 70%">
                    <tr>
                        <td>
                            ...
                            <strong>Total del Cheque</strong></td>
                        <td>
        ...
        Retenciones a aplicar:<asp:GridView ID="gv_retenciones" runat="server" 
        ...
        <tr>
            <td align="center" colspan="4">
                ...
                <asp:Button ID="btn_printret" runat="server" onclick="btn_printret_Click" 
                    Text="Imprimir retenciones" Enabled="False" />
            </td>
        </tr>
        <tr>
            <td colspan="4">
