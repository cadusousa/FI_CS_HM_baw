<%@ Page Language="C#" MasterPageFile="~/operations/manager.master" AutoEventWireup="true" CodeFile="view_transferencias.aspx.cs" Inherits="operations_pop_cheques" Title="AIMAR - BAW" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" Runat="Server">
    <div id="box">
    <h3 id="adduser">TRANSFERENCIA</h3>
<asp:ScriptManager ID="ScriptManager1" runat="server" />
        ...
        <tr>
            <td>
                ...
                <asp:Label ID="lbl_cheque_correlativo" runat="server" Visible="False"></asp:Label>
                <br />
                Banco:                 
    ...
    <tr><td align="center">
            <table width="650">
                <thead>
                <tr>
                    <th colspan="6">Detalle de Transferencias (cortes o recibos pagados)</tr>
                </thead>
                <tr><td>
        ...
        <tr>
            <td align="center">
                <asp:Button ID="btn_imprimir" runat="server" onclick="btn_imprimir_Click" 
                    Text="Re-Imprimir" Visible="False" />
                <asp:Button ID="btn_printret" runat="server" onclick="btn_printret_Click" 
                    Text="Imprimir retenciones" Visible="False" />
            </td>
        </tr>
        </table>
      </div>
