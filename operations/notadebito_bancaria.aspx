<%@ Page Language="C#" MasterPageFile="~/operations/manager.master" AutoEventWireup="true" CodeFile="notadebito_bancaria.aspx.cs" Inherits="operations_Ajustes" Title="AIMAR - BAW" %>
...
&nbsp;&nbsp;&nbsp;&nbsp; <b>Valor</b>
                <asp:TextBox ID="tb_valor" runat="server" Height="16px" AutoPostBack="True" 
                    ontextchanged="tb_valor_TextChanged"></asp:TextBox>
                <br />
                <br />
                <b>Motivo</b>
                <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                &nbsp;<asp:TextBox ID="tb_monto" runat="server" Height="16px" 
                    AutoPostBack="True" ontextchanged="tb_monto_TextChanged"></asp:TextBox>
