...
public partial class operations_cheques_search : System.Web.UI.Page
{
    ...
    protected void btn_buscar_Click(object sender, EventArgs e)
    {
        ...
        if (!tb_chequeNo.Text.Trim().Equals("")) 
        {
            ...
            where += " and tcg_no_transferencia='" + tb_chequeNo.Text + "' ";
        }
        ...
        if (!lb_tipopersona.SelectedValue.Equals("0"))
        {
            if (!tb_agenteID.Text.Trim().Equals(""))
            {
                ...
                else
                {
                    ...
                    where += " and tcg_cli_id=" + tb_agenteID.Text.Trim();
                }
            }
        }
       
        ArrayList Arr = null;
        Arr = DB.getTransferenciasGeneradas(where, int.Parse(lb_tipopersona.SelectedValue.ToString()));
        dt = (DataTable)Utility.fillGridView("transfereciasgeneradas", Arr);
    ...
    protected void gv_cheques_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Select")
        {
            ...
            Response.Redirect("view_transferencias.aspx?chequeNo="+lb1.Text);
        }
