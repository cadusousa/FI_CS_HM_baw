...
public partial class operations_ndlist_forNC : System.Web.UI.Page
{
    ...
    protected void btn_buscar_Click1(object sender, EventArgs e)
    {
        ...
        string sql = " select nd.tnd_id,nd.tnd_serie,nd.tnd_correlativo,nd.tnd_cli_id,nd.tnd_nit,nd.tnd_nombre,nd.tnd_fecha_emision, ";
        //sql += " tnd_total,tnd_moneda,tnd_hbl,tnd_mbl,tnd_contenedor,tnd_routing,'' from tbl_nota_debito where tnd_tpi_id <> 3 and tnd_cli_id=" + cliID + "  ";
        sql += " nd.tnd_total,nd.tnd_moneda,nd.tnd_hbl,nd.tnd_mbl,nd.tnd_contenedor,nd.tnd_routing,'', t.ted_nombre from tbl_nota_debito nd"
        + " left join tbl_estado_documento t on t.ted_id = nd.tnd_ted_id"
        + " where nd.tnd_tpi_id <> 3 ";
        if (!tb_agenteID.Text.Trim().Equals("")) sql += " and nd.tnd_cli_id=" + cliID + "  ";
        sql += " and nd.tnd_tpi_id=" + tpi + " and nd.tnd_moneda=" + lb_moneda.SelectedValue + " and nd.tnd_ted_id=" + ted + " and nd.tnd_tcon_id=" + user.contaID + " and nd.tnd_pai_id=" + user.PaisID + " ";
        //sql += " and tnd_tpi_id=" + tpi + " and tnd_moneda=" + user.Moneda + " and tnd_ted_id=" + ted + " and tnd_tcon_id=" + user.contaID + " and tnd_pai_id=" + user.PaisID + " ";
        dt = (DataTable)DB.getND(sql);
    ...
    protected void gv_detalle_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Detalle")
        {
            ...
            Response.Redirect("notacreditoND.aspx?ndID=" + id);
        }
    }
