...
public partial class invoice_searchBL : System.Web.UI.Page
{
    ...
    protected void dgw1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Seleccionar")
        {
            ...
            if (lb_tipo.SelectedValue.Equals("TERRESTRE T"))
            {
                Response.Write("<script languaje='JavaScript'>window.opener.location.href='notadebitoprov.aspx?bl_no=" + dgw1.Rows[index].Cells[2].Text + "&tipo=" + lb_tipo.SelectedValue + "&opid=" + dgw1.Rows[index].Cells[6].Text + "&blid=" + dgw1.Rows[index].Cells[7].Text + "&bldetailid=" + dgw1.Rows[index].Cells[8].Text + "'; window.close();</script>");
            }
            else
            {
                Response.Write("<script languaje='JavaScript'>window.opener.location.href='notadebitoprov.aspx?bl_no=" + dgw1.Rows[index].Cells[2].Text + "&tipo=" + lb_tipo.SelectedValue + "&opid=" + dgw1.Rows[index].Cells[6].Text + "&blid=" + dgw1.Rows[index].Cells[7].Text + "'; window.close();</script>");
            }
