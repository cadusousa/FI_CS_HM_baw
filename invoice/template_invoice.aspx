<%@ Page Language="C#" AutoEventWireup="true" CodeFile="template_invoice.aspx.cs" Inherits="invoice_template_invoice" %>
                        ...
                        <td>
                            <table align="center" cellpadding="0" cellspacing="0" class="style3">
                                ...
                                <asp:Image ID="Image1" runat="server" Height="100px" ImageUrl="~/img/aimar.jpg" Width="300px" />
                                    ...
                                    <h1>
                                        <asp:Label ID="lb_nombre_agente" runat="server" Text="" 
...
&nbsp;<asp:Label ID="lbl_serie" runat="server" CssClass="style7"></asp:Label><asp:Label ID="lbl_correlativo" 
                    ...
                    <tr>
                        ...
                        <table width="100%">
                        <tr>
                            <td  class="style16" align="left">No. de Orden de Compra Exenta:</td>
                            <td  class="style16" align="left">No. de Constancia de Registro Exonerado:</td>
                            <td  class="style16" align="left">No. de Registro SAG:</td>
                        </tr>
                        </table>
                        <% } %>
                        </td>
                            ...
                            <table cellpadding="0" cellspacing="0" class="style3">
                                <tr>
                                    ...
                                    <% if ((user.PaisID == 3 || user.PaisID == 23) && (user.SucursalID == 102 || user.SucursalID == 104) && (user.contaID == 1))
                                       { %>
                                    <table align="center" cellpadding="0" cellspacing="0" class="style4" border=0>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="2" class="style8">
                                                    <asp:Label ID="Label9" runat="server" Text="Descuentos y Rebajas Otorgados"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" class="style8">
                                            ...
                                            <tr>
                                                <td colspan="2"  class="style8"><asp:Label ID="Label4" runat="server" Text="Subtotal Gravado"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"  class="style8"><asp:Label ID="Label5" runat="server" Text="Subtotal Exento"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"  class="style8"><asp:Label ID="Label7" runat="server" Text="Subtotal Exonerado"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" class="style8"><asp:Label ID="Label6" runat="server" Text="15% ISV"></asp:Label></td>
                                            </tr>
                                          <tr>
                                                <td colspan="2" class="style8"><asp:Label ID="Label8" runat="server" Text="Total"></asp:Label></td>
                                            </tr>
                                        </table>
                                        ...
                                        <table align="center" cellpadding="0" cellspacing="0" class="style4" border=0>
                                            ...
                                            <tr>
                                                <td align="right" class="style15">
                                                    <asp:Label ID="lbl_rebajas_usd_hn" runat="server" CssClass="style6"></asp:Label>
                                                </td>
                                                <td colspan="2" width="100px" align="right">
                                                    <asp:Label ID="lbl_rebajas" runat="server" CssClass="style6"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" class="style15">
                                            ...
                                            <tr>
                                                <td align="right" class="style15">
                                                    <asp:Label ID="lbl_subtotal_usd_exento" runat="server" CssClass="style6"></asp:Label>
                                                </td>
                                                <td colspan="2" width="100px" align="right">
                                                    <asp:Label ID="lbl_subtotal_exento" runat="server" CssClass="style6"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" class="style15">
                                                    <asp:Label ID="lbl_subtotal_usd_exonerado" runat="server" CssClass="style6"></asp:Label>
                                                </td>
                                                <td colspan="2" width="100px" align="right">
                                                    <asp:Label ID="lbl_subtotal_exonerado" runat="server" CssClass="style6"></asp:Label>
                                                </td>
                                            </tr>
