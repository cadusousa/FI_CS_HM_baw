<%@ Page Title="AIMAR - BAW" Language="C#" MasterPageFile="~/invoice/manager.master" AutoEventWireup="true" CodeFile="NC_ajustes_nd.aspx.cs" Inherits="invoice_NC_ajustes_nd" %>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    <br />
                    Serie de Nota Debito: 
                    <asp:DropDownList ID="lb_serie_factura" runat="server" Width="120px">
                    </asp:DropDownList>&nbsp;Correlativo de Nota Debito:<asp:TextBox ID="lb_facid" 
    ...
    <br />
        ...
        <tbody>
            <tr><td align="center">
                ...
                &nbsp;<asp:Label ID="lbl_anulacion" runat="server" Font-Bold="True" Text="Anular Nota de Debito con este Ajuste"></asp:Label>
            </td></tr>
        </tbody>
        </table>
                                            <br />
        ...
        <thead>
            <tr>
                <th colspan="5" align="center">Detalle de Nota de Debito</th>
             </tr>
        </thead>
        <tbody>
            <tr><td>
