<%@ Page Language="C#" MasterPageFile="~/invoice/manager.master" AutoEventWireup="true" CodeFile="searchND_cliente.aspx.cs" Inherits="invoice_searchdoc" Title="AIMAR - BAW" %>

<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" Runat="Server">
<div id="box">
<h3 id="adduser">BUSCAR NOTA DEBITO<asp:ScriptManager ID="ScriptManager1" runat="server" />
                            </h3>
<table width="700">
    <tr><td>
