<%@ Page Language="C#" AutoEventWireup="true" CodeFile="searchBL_invoice_proforma2.aspx.cs" Inherits="invoice_searchBL"  Title="AIMAR - BAW"%>
                ...
                <tr>
                    <td align="center">
                        <asp:GridView ID="dgw1" runat="server" onrowcommand="dgw1_RowCommand" 
                            ...
                            PageSize="10" onrowcreated="dgw1_RowCreated">
                            <Columns>
