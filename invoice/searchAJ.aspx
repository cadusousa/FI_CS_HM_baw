<%@ Page Title="AIMAR - BAW" Language="C#" MasterPageFile="~/invoice/manager.master" AutoEventWireup="true" CodeFile="searchAJ.aspx.cs" Inherits="invoice_searchAJ" %>

<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" Runat="Server">
    <div id="box">
<h3 id="adduser">BUSCAR AJUSTE CONTABLE<asp:ScriptManager ID="ScriptManager1" runat="server" />
                            </h3>
<table width="650">
    <tr><td>
