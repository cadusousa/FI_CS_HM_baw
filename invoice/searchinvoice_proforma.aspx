<%@ Page Language="C#" MasterPageFile="~/invoice/manager.master" AutoEventWireup="true" CodeFile="searchinvoice_proforma.aspx.cs" Inherits="invoice_searchdoc" Title="AIMAR - BAW" %>

<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" Runat="Server">
<div id="box">
<h3 id="adduser">BUSCAR FACTURA<asp:ScriptManager ID="ScriptManager1" runat="server" />
                            </h3>
<table width="650">
    <tr><td>
            ...
            <tr>
                <td>
                    <asp:GridView ID="gv_facturas" runat="server" 
                        ...
                        onrowcreated="gv_facturas_RowCreated1">
