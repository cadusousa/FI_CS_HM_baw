...
public partial class invoice_print_invoice : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        RE_GenericBean datosfactura = (RE_GenericBean)DB.getNotaDebitoData(fac_id);
        DataTable dt=(DataTable)DB.getRubbyFact(fac_id, 4);
        ArrayList camposfact = (ArrayList)DB.getCamposDoc(4, datosfactura.intC2, datosfactura.strC28);//parametros 4=nota debito (tipo doc); 2=sucursal de la factura; 3=serie de factura
