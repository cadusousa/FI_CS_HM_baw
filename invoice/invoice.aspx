<%@ Page Language="C#" MasterPageFile="~/invoice/manager.master" AutoEventWireup="true" CodeFile="~/invoice/invoice.aspx.cs" Inherits="invoice_invoice" Title="AIMAR - BAW"%>
...
<h3 id="adduser" align="left">FACTURACION</h3>
<table width="650">
    <tr><td>
...
&nbsp;<asp:Label ID="lb_fecha_hora" runat="server" Visible="False"></asp:Label>
                    ...
                    <input id="Button2" type="button" value="Cargar a Partir de un DOCUMENTO"  
                                    ...
                                    onclick="javascript:window.open('searchBL_invoice.aspx', null, 'toolbar=no,resizable=no,status=no,width=400,height=600');" onclick="return Button2_onclick()" /></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <strong>MONEDA A FACTURAR</strong></td>
                            <td>
                    ...
                    <asp:TextBox ID="tb_correlativo" runat="server" Enabled="False" Height="16px" 
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drp_tipopersona" runat="server" AutoPostBack="True" 
                                    onselectedindexchanged="drp_tipopersona_SelectedIndexChanged">
                        ...
                        <tr>
                            <td>
                                Nit</td>
                            <td>
                    <asp:TextBox ID="tb_nit" runat="server" Height="15px" 
...
function Button2_onclick() {
    ...
    style="width: 90%">
            ...
            <tr>
                <td>
                                        ...
                                        <asp:Label ID="lb_hbl" runat="server" Text="HBL"></asp:Label>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="tb_hbl" runat="server" Height="16px" Width="215px" 
                                            ReadOnly="True" MaxLength="49"></asp:TextBox>
        ...
        <asp:Label ID="lb_contenedor" runat="server" Text="Contenedor"></asp:Label>
                                            ...
                                            ReadOnly="True" style="text-transform:uppercase;" MaxLength="49"></asp:TextBox>
                                        ...
                                        <tr>
                                                <td>
                                                    <asp:Label ID="lb_file" runat="server" Text="FILE" style="display:none"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="tb_file" runat="server" Height="16px" Width="250px" 
                                            ReadOnly="True" MaxLength="49"  style="display:none"></asp:TextBox>
                                                </td>
                                        </tr>
                                        ...
                                        <asp:TextBox ID="tb_vendedor2" runat="server" Width="150px" Height="15px" 
                                            ...
                                            <tr>
                                                <td>
                                                    Poliza Aduanal</td>
                                                <td>
                    <asp:TextBox ID="tb_orden" runat="server" Height="15px" Width="250px" MaxLength="90"></asp:TextBox>
                                                </td>
                                                <td>
                                                    Regimen Aduanero</td>
                                                <td>
                                        <asp:DropDownList ID="drp_regimen_aduanero" runat="server">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    Dua de Salida</td>
                                                <td>
                    <asp:TextBox ID="tb_dua_salida" runat="server" Height="15px" Width="250px" MaxLength="90"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                        ...
                                        <asp:TextBox ID="tb_no_embarque" runat="server" Height="16px" Width="250px" 
                                                ...
                                                <td>
                                                    Certificado de Seguro</td>
                                                <td>
                                        <asp:TextBox ID="tb_poliza_seguros" runat="server" Height="16px" Width="250px" 
                                                        MaxLength="50"></asp:TextBox>
                                                    ...
                                                    <asp:Label ID="lbl_poliza_seguro_id" runat="server" Text="0" Visible="False"></asp:Label>
    ...
    <table width="650">
        <thead>
            <tr>
                <th colspan="5">Detalle Guias Aereas Batch</th>
            </tr>
        </thead>
        <tr>
            <td>
                <asp:GridView ID="gv_detalle_guias" runat="server"
                EmptyDataText="No hay guias que facturar" Width="95%" Font-Size="X-Small">
        ...
        <table width="650">
            <thead>
                      <tr>
                          <th colspan="5">Detalle de Rubros</asp:Label>                </th>
                      </tr>
                  </thead>
            <tr>
                <td align="center">
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                ...
                <asp:TemplateField HeaderText="Comentarios">
                    <ItemTemplate>
                        <asp:TextBox ID="tb_comentario" runat="server" Text='<%# Eval("COMENTARIO") %>' 
                            Height="16px"  MaxLength="100" Width="70px"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Tipo">
                    ...
                    <ItemStyle HorizontalAlign="Right" BackColor="#CCFFFF" Font-Bold="True" />
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="tb_subtotal" runat="server" Enabled="False" BackColor="White" style=" text-align:right"
            ...
            <tr>
                ...
                <td style="height: 25px">
                    ...
                    <asp:TextBox ID="tb_impuesto" runat="server" Enabled="False" BackColor="White" style=" text-align:right"
                        BorderStyle="None">0</asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="tb_total" runat="server" Enabled="False" BackColor="White" style=" text-align:right"
                        BorderStyle="None">0</asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="tb_totaldolares" runat="server" Enabled="False" style=" text-align:right"
    ...
    <tr><td>
        <div align="center">
            ...
            <asp:Button ID="bt_impresion_invoice" runat="server" Visible="False" 
                Text="Impresion Invoice" onclick="bt_impresion_invoice_Click" />
    ...
    <asp:Panel ID="pnlCliente" runat="server" CssClass="CajaDialogo" Width="730px" 
        style="display:none;" HorizontalAlign="Center" DefaultButton="Button4">
        <div align="center">
            <table align="center">
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="Cancel_cliientebtn" runat="server" Text="Cancelar" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
    ...
    <cc1:ModalPopupExtender ID="modalPaquetes2" runat="server" TargetControlID="tb_paquetes2"
            ...
            OnCancelScript="mpeClienteOnCancel()" DropShadow="True"
            BackgroundCssClass="FondoAplicacion" />
    <cc1:ModalPopupExtender ID="modal_poliza_seguros" runat="server" TargetControlID="tb_poliza_seguros"
            PopupControlID="pnl_poliza_seguros" CancelControlID="btnCuentaCancelar"
            OnCancelScript="mpeClienteOnCancel()" DropShadow="True"
            BackgroundCssClass="FondoAplicacion" />
    ...
    <asp:Panel ID="pnl_poliza_seguros" runat="server" CssClass="CajaDialogo" Width="750px" 
        style="display:none;" HorizontalAlign="Center">
        <div align="center">
            <table align="center">
                <tr>
                    <td colspan="2">
                        <div style="padding: 10px; background-color: #0033CC; color: #FFFFFF;">
                            <asp:Label ID="Label13" runat="server" Text="Buscar Certificado de Seguro" />
                        </div>
                    </td>
                </tr>
                <tr>
                    <td align="left" width="130">
                        Buscar por:</td>
                    <td align="left">
                        <asp:DropDownList ID="drp_tipo_documento_asegurado" runat="server">
                            <asp:ListItem Value="1">RO</asp:ListItem>
                            <asp:ListItem Value="2">HOUSE</asp:ListItem>
                            <asp:ListItem Value="3">CERTIFICADO</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td align="left" width="130">
                        Numero:</td>
                    <td align="left">
                        <asp:TextBox ID="tb_documento_asegurado" runat="server" Height="16px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td align="left">
                ...
                <tr>
                    <td>
                        <asp:Button ID="btn_buscar_poliza_seguro" runat="server" onclick="btn_buscar_poliza_seguro_Click" 
                            Text="Buscar" />
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <div style="padding: 10px; background-color: #0033CC; color: #FFFFFF;">
                            <asp:Label ID="Label25" runat="server" Text="Seleccionar" />
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="gv_poliza_seguros" runat="server" AllowPaging="True" 
                            AutoGenerateSelectButton="True" 
                            onpageindexchanged="gv_poliza_seguros_PageIndexChanged" 
                            onpageindexchanging="gv_poliza_seguros_PageIndexChanging" 
                            onselectedindexchanged="gv_poliza_seguros_SelectedIndexChanged">
                        </asp:GridView>
                    </td>
                </tr>
            </table>
