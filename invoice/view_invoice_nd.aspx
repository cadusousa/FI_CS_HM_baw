<%@ Page Title="" Language="C#" MasterPageFile="~/invoice/manager.master" AutoEventWireup="true" CodeFile="view_invoice_nd.aspx.cs" Inherits="invoice_view_invoice_nd" %>
...
<div id="box" align="center">
    ...
    <h3 id="adduser">NOTA CREDITO A NOTA DE DEBITO</h3>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="lb_serieNC" runat="server" AutoPostBack="True" 
                        onselectedindexchanged="lb_serieNC_SelectedIndexChanged">
                    </asp:DropDownList>
                    </td>
                <td>
                ...
                <td>
                    <asp:TextBox ID="tb_corrNC" runat="server" 
                        Enabled="false" Width="120px" Text="0" Height="16px" 
                        ontextchanged="tb_corrNC_TextChanged"></asp:TextBox>
    ...
    style="width: 50%">
            ...
            <tr>
                <td>
                    Direccion</td>
                <td colspan="3">
                    <asp:TextBox ID="tb_direccion" runat="server" Height="15px" Width="545px" 
                        ReadOnly="True"></asp:TextBox>
                    </td>
            </tr>
            <tr>
        ...
        <asp:Label ID="lb_contenedor" runat="server" Text="Contenedor"></asp:Label>
            ...
            <tr>
                <td>
                    Naviera</td>
                <td>
                    <asp:TextBox ID="tb_naviera" runat="server" Height="15px" Width="250px"></asp:TextBox>
                    </td>
                <td>
                    Vapor</td>
                <td>
                    <asp:TextBox ID="tb_vapor" runat="server" Height="15px" Width="250px"></asp:TextBox>
                    </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    Comodity</td>
                <td>
                    <asp:TextBox ID="tb_comodity" runat="server" Height="15px" Width="250px"></asp:TextBox>
                    </td>
                <td>
                    &nbsp;</td>
                <td>
                                                    ...
                                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 90%">
                                                        <tr>
                                                            <td>
                                                                Peso</td>
                                                            <td>
                    <asp:TextBox ID="tb_peso" runat="server" Height="15px" Width="50px"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                Volumen</td>
                                                            <td>
                                                                <asp:TextBox ID="tb_vol" runat="server" Height="15px" Width="50px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                    </td>
                                                    ...
                                                    <table align="center" cellpadding="0" cellspacing="0" style="width: 80%">
                                                        <tr>
                                                            <td>
                                                                Vendedor:</td>
                                                            <td>
                    <asp:TextBox ID="tb_vendedor1" runat="server" Height="15px" Width="150px"></asp:TextBox>
                                        
                                                            </td>
                                                            <td>
                                        
                                                                <asp:TextBox ID="tb_vendedor2" runat="server" Width="150px" Height="15px"></asp:TextBox>
    ...
    <br />
        ...
        <thead>
            <tr>
                <th colspan="5" align="center">Detalle Nota de Debito</th>
             </tr>
        </thead>
        <tbody>
            <tr><td>
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="tb_subtotal" runat="server" ReadOnly="True" Height="16px"></asp:TextBox>
                    <br />
