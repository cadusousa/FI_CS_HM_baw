...
public partial class invoice_searchBL : System.Web.UI.Page
{
    ...
    protected void dgw1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Seleccionar")
        {
            ...
            Response.Write("<script languaje='JavaScript'>window.opener.location.href='invoiceAux.aspx?bl_no=" + dgw1.Rows[index].Cells[2].Text + "&tipo=" + lb_tipo.SelectedValue + "'; window.close();</script>");
