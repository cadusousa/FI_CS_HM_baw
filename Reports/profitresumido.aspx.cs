...
public partial class Reports_profitresumido : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //tb_fechainicial.Text = Fecha.Month.ToString()+ "/01/"  + Fecha.Year.ToString();
        ...
        l_contabilidad.Visible = false;
        lb_contabilidad.Visible = false;
        lb_contabilidad.SelectedValue = "3";
    }
    ...
    protected void btn_generar_Click(object sender, EventArgs e)
    {
        ...
        Bean_Log.strC1 = "PROFIT RESUMIEDO";
        ...
        mensaje += "window.open('reports.aspx?reptype=6&FechaIni=" + tb_fechainicial.Text + "&FechaFin=" + tb_fechafinal.Text + "&MBL=" + tb_mbl.Text.Trim() + "&tipopersona="+lb_tipopersona.SelectedValue+"&codigopersona="+tb_agenteID.Text.Trim()+"&monID="+lb_moneda.SelectedValue+"&TipoConta="+ lb_contabilidad.SelectedValue + "','Genera_Reporte','menubar=1,resizable=1,scrollbars=1,toolbar=1,width=750');";
        mensaje += "</script>";
