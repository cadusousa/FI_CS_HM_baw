...
public partial class Reports_SolicitaER_2 : System.Web.UI.Page
{
    ...
    protected void btn_generar_Click(object sender, EventArgs e)
    {
        ...
        Bean_Log.strC1 = "LIBRO DE COMPRAS";
        ...
        mensaje += "window.open('Libro_Compras.aspx?t_con=" + lb_contabilidad.SelectedValue + "&t_mon=" + lb_moneda.SelectedValue + "&t_doc=" + Rb_documento.SelectedValue + "&docts=" + Documentos + "&t_tpi=" + lb_tipo_persona.SelectedValue + "&grupo=" + lb_grupo.SelectedValue + "&f_inicial=" + tb_fechainicial.Text.Trim() + "&f_final=" + tb_fechafinal.Text.Trim() + "&t_ted=" + Teds + "','Genera_Reporte','resizable=1,scrollbars=1,toolbar=1,width=750');";
        mensaje += "</script>";
