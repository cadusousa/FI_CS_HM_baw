...
public partial class Reports_Soa_regional : System.Web.UI.Page
{
    ...
    protected void bt_generar_Click(object sender, EventArgs e)
    {
       ...
       // if (chk_pendliq.Checked) solopendiente = 1;
        ...
        mensaje += "window.open('rep_soa_regional.aspx?tpi=" + lb_tipopersona.SelectedValue + "&cliID=" + tb_agenteID.Text + "&monID=" + user.Moneda + "&fechafin=" + tb_fechafin.Text + "&nombre=" + tb_agentenombre.Text + "&reptype=1','Genera_Reporte','menubar=1,resizable=1,scrollbars=1,toolbar=1,width=750');";
        mensaje += "</script>";
    ...
    protected void bt_buscar_Click(object sender, EventArgs e)
    {
        ...
        else if (lb_tipopersona.SelectedValue.Equals("10"))
        {
            ...
            if (!tb_nitb.Text.Trim().Equals("") && tb_nitb.Text != null)
                if (!where.Equals("")) where += " and nit='" + tb_nitb.Text + "'"; else where += "nit='" + tb_nitb.Text + "'";
            Arr = (ArrayList)DB.Get_Intercompanys(where); //Proveedor
