<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/manager.master" AutoEventWireup="true" CodeFile="profitresumido.aspx.cs" Inherits="Reports_profitresumido" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Contenido" Runat="Server">
    <div id="box">
<fieldset id="Fieldset1">
<h3 id="adduser">PROFIT RESUMIDO</h3>
    ...
    <tr>
        <td>
            ...
            <tr>
             ...
             <tr>
                <td colspan="2"> <asp:Panel ID="Panel1" runat="server">
                    <asp:Label ID="l_contabilidad" runat="server" Text="Tipo Contabilidad"></asp:Label>
                    &nbsp;
