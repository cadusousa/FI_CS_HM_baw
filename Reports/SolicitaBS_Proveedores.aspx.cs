...
public partial class Reports_SolicitaER_2 : System.Web.UI.Page
{
    ...
    protected void btn_generar_Click(object sender, EventArgs e)
    {
        ...
        mensaje += "window.open('balance_saldos_proveedores.aspx?monID=" + lb_moneda.SelectedValue + "&tcon=" + lb_contabilidad.SelectedValue + "&fecha_inicial=" + tb_fechainicial.Text + "&fecha_final=" + tb_fechafinal.Text + "&ted=" + Teds + "&ban_saldo=" + ban_saldo + "','Genera_Reporte','menubar=1,resizable=1,scrollbars=1,toolbar=1,width=750');";
        mensaje += "</script>";
