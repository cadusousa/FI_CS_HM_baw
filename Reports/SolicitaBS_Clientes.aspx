<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/manager.master" AutoEventWireup="true" CodeFile="SolicitaBS_Clientes.aspx.cs" Inherits="Reports_SolicitaER_2" %>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server" />
            ...
            <thead>
                ...
                <td align="center" colspan="2">
                    <b><span style="font-size: small">&nbsp;Balance de Documentos X Cobrar</span></b></td>
                </tr>
            </thead>
                <tr>
                <td>Fecha Inicial</td>
                ...
                <tr>
                    <td style="height: 106px">Estado</td>
