<%@ Page Title="" Language="C#" MasterPageFile="~/ventas/manager.master" AutoEventWireup="true" CodeFile="Corte_comision.aspx.cs" Inherits="ventas_Corte_comision" %>
    ...
    <tr>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server" />
            ...
            <tr>
                <td>Vendedor: </td>
                <td >
                    <asp:DropDownList ID="ddl_vendedores" runat="server" width="150px" 
                        AutoPostBack="True"  >
                    </asp:DropDownList>
                </td>
            </tr>
                ...
                <tr>
                    <td>Estado Corte:</td>
                    <td> <asp:DropDownList ID="ddl_estado" runat="server">
                    <asp:ListItem Value="0">Todo</asp:ListItem>
                    <asp:ListItem Value="1">Pendiente de liquidar</asp:ListItem>
