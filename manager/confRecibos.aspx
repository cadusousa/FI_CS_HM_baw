<%@ Page Language="C#" MasterPageFile="~/manager/manager.master" AutoEventWireup="true" CodeFile="confRecibos.aspx.cs" Inherits="manager_confRecibos" Title="AIMAR - BAW" %>
        ...
        <asp:GridView ID="gv_conf_cuentas" runat="server" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Debe">
                    <ItemTemplate>
                        <asp:TextBox ID="tb_debe" runat="server" Text='<%# Eval("Debe") %>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Haber">
                    <ItemTemplate>
                        <asp:TextBox ID="tb_haber" runat="server"  Text='<%# Eval("Haber") %>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
