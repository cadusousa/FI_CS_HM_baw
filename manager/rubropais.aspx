<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rubropais.aspx.cs" Inherits="manager_rubropais"  Title="AIMAR - BAW"%>
...
<body>
    <div id="content">
        ...
        <table width="350" align="left">
            <thead>
                <tr><th colspan="2">Asociación a pais</th></tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <td align="right">Cobra iva: </td>
                    <td>
                        <asp:CheckBox ID="cobraiva" runat="server" TextAlign="Left" />
                    </td>
                </tr>
                <tr>
                    <td align="right">Iva incluido: </td>
                    <td>
                        <asp:CheckBox ID="ivaincluido" runat="server" TextAlign="Left" />
                    </td>
                </tr>
                <tr>
